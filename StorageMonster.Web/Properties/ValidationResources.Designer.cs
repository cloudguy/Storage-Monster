...
namespace StorageMonster.Web.Properties {
    ...
    public class ValidationResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Field &apos;{0}&apos; must be not more than {2} characters and note less than {1} characters.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Field &apos;{0}&apos; must be not more than {2} characters.
        /// </summary>
        public static string StringLengthLessThanFormat {
            get {
                return ResourceManager.GetString("StringLengthLessThanFormat", resourceCulture);
            }
        }
