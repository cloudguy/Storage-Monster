...
namespace StorageMonster.Web.Services.Security
{
    public class MonsterRoleProvider : System.Web.Security.RoleProvider
    {
        ...
        {
            var userRoleService = IocContainer.Instance.Resolve<IUserService>();
			var roles = userRoleService.GetRolesForUser(useremail);
        ...
        {
			var userRoleService = IocContainer.Instance.Resolve<IUserService>();
			return userRoleService.IsUserInRole(userEmail, roleName);
        }
